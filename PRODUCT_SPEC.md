...
**Copy tone (owner 2026-09-13):** лёгкий премиальный язык, цельные фразы; не обрывать мысль тире и не писать «телеграфно». Умеренная длина. Пункт 3 (барабан) не менять.
...
3. **Эффект барабана** *(locked example — do not rewrite)*
...
5. **Остальное** *(draft)*
   ...
   - **Форма.** Тезис: `Две формы панели под разные потолки и сценарии света.` Why: `Flat и Wave помогают сохранить геометрию и освещение, не жертвуя акустическим спокойствием.`
