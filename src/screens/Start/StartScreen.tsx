    ...
    <Screen hero>
      <div className={styles.hero}>
        ...
        <p className={styles.lead}>
          Проблемомер помогает почувствовать разницу: обычный потолок и потолок
          с бескаркасной системой MultiFrame — без сложных терминов и «инженерных» обещаний.
        </p>
        ...
        <ul className={styles.points}>
          ...
          <li>Экспертная качественная оценка</li>
