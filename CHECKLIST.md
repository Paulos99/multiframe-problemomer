...
| Floor-above options (confirmed 2026-09-13) | Только: `Не знаю` · `Обычный пол (без плавающей схемы)` · `Есть плавающий пол / шумоизоляция в полу`. «Без чистового пола» — не параметр пола (см. стадию). |
