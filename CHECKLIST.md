...
| Room required fields (confirmed 2026-09-13) | Обязательны только **тип комнаты** и **площадь**. Пол сверху, тип дома, стадия, потолок, шумные соседи — можно `Не знаю`, «Далее» доступно. |
