...
| Comfort class labels (confirmed direction 2026-09-13) | Официально (Трофимов): **А** высокая комфортность, **Б** комфортная, **В** предельно допустимая. В UI — **понятное имя + буква** (напр. «Комфорт (Б)»), мягкая отсылка к нормативному документу. **Не** называть А «эконом» (А — верх шкалы). |
