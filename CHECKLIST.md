...
| Audio reduction UI (confirmed 2026-09-13) | **C:** `≈ −{n}%` **+** подпись Δ (`ориентир −8 дБ`). Обязательно: дБ **логарифмические** — −8 дБ ≈ **существенно тише (~в ~2 раза по восприятию)**, не «−5%» линейно (64→56 — не копеечная разница). % в UI = **восприятие**, не (ΔдБ / уровень). |
