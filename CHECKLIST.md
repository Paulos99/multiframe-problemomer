...
| Audio reduction UI (confirmed 2026-09-13) | **C:** `≈ −{n}%` **+** Δ (`ориентир −8 дБ`). % = восприятие, не линейный Δ/уровень. Сноска **F2:** `Шкала дБ логарифмическая: −8 дБ — заметно тише (~вдвое по ощущению).` |
