...
| Before/After chrome (2026-09-13) | Subtitle **S3:** `Как меняется комфорт комнаты с MultiFrame`. Numbers title **N3:** `Оценка в цифрах`. Honesty **H3** — смысл ок, формулировка ещё правится. |
