...
| Room = primary diagnostic (2026-09-13) | Тип + площадь + перекрытие — обязательно. Кандидаты добавить: **пол сверху** (сильнее всего на удар), тип дома, стадия объекта, планируемый потолок. Ждём выбор владельца. |
